...
struct AddSympton: View {
    @State var selected :Bool = false
    var body: some View {
        ZStack() {
            VStack(spacing: 20) {
                ZStack() {
                    Image(resource: selected ? "addsympton_on":"addsympton", ofType: "svg")
                ...
                Text("添加症状与状态")
                    ...
                    .lineSpacing(21.60)
                    .foregroundColor(
                        selected ? Color(red: 0.19, green: 0.55, blue: 0.91) : Color(red: 0.33, green: 0.33, blue: 0.33))
            }
...
struct AddSympton_Previews: PreviewProvider {
